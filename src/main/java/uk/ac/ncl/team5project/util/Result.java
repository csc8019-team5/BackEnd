...
public class Result<T> {
	...
	public static Result fail(String message,String data){return new Result(409, message, null);}
	...
	public static Result conflict(String message){return new Result(409, message, null);}
