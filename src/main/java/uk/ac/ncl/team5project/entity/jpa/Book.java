package uk.ac.ncl.team5project.entity.jpa;
 ...
 * </pre>
 *
 * This is a JPA entity class representing the BOOK table in the database.
 * It is used for database operations and persistence with JPA and Hibernate.
 * This class is different from the MyBatis-Plus Book class
 */
@Data
@Entity
@Table(name = "\"BOOK\"")
